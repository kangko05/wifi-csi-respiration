...
> 현재 `python-resume`에는 C 구현·실행 파일이 없다. 이 문서는 보존된 C 대조 경로 안내이며 실제 C 계산은 `archive/onboard-20260922`의 별도 작업 폴더에서 수행한다.
...
```powershell
.venv/bin/python scripts/run_c_amplitude.py --session 20260916T060200_034260_9dd9fd80
```
